...
public class NDArrayManager {
     ...
     * integers under the given bound.
     * 
     * @param dim1         The first dimension of the array, i.e. row
     * @param dim2         The second dimension of the arry, i.e. column
     * @param randIntBount The bound (exclusive) for the random integers to be
     *                     generated
     * @return Integer[][] The constructed 2D array
     */
    public Integer[][] array2dRandInt(Integer dim1, Integer dim2, Integer randIntBound) {

        Random randomizer = new Random();

        Integer[][] randIntArray2d = new Integer[dim1][dim2];
     ...
     * @return Integer[][] The new copy of the 2D array
     */
    public Integer[][] copyArray2d(Integer[][] array) {
     ...
     * @param randIntBount The bound (exclusive) for the random integers to be
     *                     generated
     * @return Integer[] The constructed 1D array
     */
    public Integer[] array1dRandInt(Integer dim1, Integer randIntBound) {

        Random randomizer = new Random();

        Integer[] randIntArray1d = new Integer[dim1];
        for (int indx1 = 0; indx1 < dim1; indx1++) {
     ...
     * @return Integer[] The new copy of the 1D array
     */
    public Integer[] copyArray1d(Integer[] array) {
     ...
     */
    public Double[] array1dNums(Integer dim1, Double number) {
     ...
     * @return Double[] The constructed 1D array
     */
    public Double[] array1dAbsDiff(Integer[] arr1, Integer[] arr2) {
     ...
     * 
     * @param array The array to search in
     * @return Integer The index of the maximum value
     */
    public Integer array1dMaxIndex(Double[] array) {
    ...
    /**
     * Converts a 1D integer array into a 1D double array.
     * 
     * @param intArr The integer array to convert
     * @return Double[] The newly created double array
     */
    public Double[] array1dIntToDouble(Integer[] intArr) {
